-- Enable uuid-ossp extension for uuid_generate_v5 and uuid_ns_dns
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Drop and recreate the initialize_wallet_balance function with daily CCC reward logic
...
BEGIN
  ...
  IF FOUND THEN
    ...
    IF v_last_login IS NULL OR v_last_login < v_today THEN
      ...
      VALUES (v_result.user_id, v_today, now())
  ...
  -- Insert new balance record with starter tokens (100 CCC)
  ...
  INSERT INTO trivia_user_stats (user_id, last_login_date, updated_at)
  VALUES (v_user_id, v_today, now())
  ON CONFLICT (user_id) DO NOTHING;
  
  -- Log the starter bonus transaction
  INSERT INTO token_transactions (user_id, amount, transaction_type, description)
  VALUES (v_user_id, v_starter_bonus, 'starter_bonus', 'Welcome bonus - 100 CCC');
