          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="relative z-10 p-6 space-y-5">
              ...
              <div className="space-y-3">
                {/* Merch Discount */}
                <div className="rounded-xl border border-[hsl(var(--neon-pink)/0.3)] bg-[hsl(var(--card-bg))] p-4 hover:border-[hsl(var(--neon-pink)/0.6)] transition-colors">
                ...
                {/* NFT Giveaway */}
                <div className="rounded-xl border border-[hsl(var(--neon-cyan)/0.3)] bg-[hsl(var(--card-bg))] p-4 hover:border-[hsl(var(--neon-cyan)/0.6)] transition-colors">
                  <div className="flex items-start gap-3">
