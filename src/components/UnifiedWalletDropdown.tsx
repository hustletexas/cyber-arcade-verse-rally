...
export const UnifiedWalletDropdown = () => {
  ...
  if (!isWalletConnected) {
    return <>
        <Button onClick={() => setShowWalletManager(true)} className="relative overflow-hidden group h-7 px-3 rounded-md bg-neon-cyan text-white text-xs font-bold border-0 shadow-lg shadow-neon-cyan/30 hover:shadow-neon-cyan/50 transition-all duration-500 hover:scale-105 active:scale-95">
