...
export const CyberPinball: React.FC<CyberPinballProps> = ({ onScoreUpdate, onBallLost, onGameOver }) => {
  ...
  useEffect(() => {
    ...
    const portalExit = Bodies.circle(TW - 120, 45, 10, sensorOpts('portal_exit'));
    ...
    const POP_R = 14;
    const popBumpers = [
      Bodies.circle(365, 120, POP_R, { isStatic: true, label: 'pop_bumper_0', restitution: 3.2 }),
    ];
