...
const featuredGames = [
  ...
  },
  {
    ...
    category: 'Trading Card Game',
    blockchain: 'Hive',
    image: '/lovable-uploads/splinterlands.png',
    description: 'Digital collectible card game built on blockchain technology',
    playUrl: 'https://splinterlands.com/play',
    downloadUrl: null,
    isWebBased: true,
  ...
  },
  {
    ...
    blockchain: 'Ronin',
    image: '/lovable-uploads/axie-infinity.png',
    description: 'Turn-based battle game where players collect, breed, and battle creatures',
    playUrl: 'https://axieinfinity.com/play',
  ...
  },
  {
    ...
    category: 'Metaverse',
    blockchain: 'Ethereum',
    image: '/lovable-uploads/the-sandbox.png',
    description: 'Virtual world where players can build, own, and monetize gaming experiences',
    playUrl: 'https://sandbox.game/play',
    downloadUrl: 'https://sandbox.game/download',
    isWebBased: false,
