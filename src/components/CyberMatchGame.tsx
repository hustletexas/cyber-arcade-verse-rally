...
export const CyberMatchGame: React.FC = () => {
  ...
  return (
    <div className="cyber-match-container relative rounded-2xl overflow-hidden bg-gradient-to-br from-black via-purple-950/50 to-blue-950/50 border border-cyan-500/30">
      ...
      <div className="relative z-10 p-4 sm:p-6">
        ...
        <div className="mb-4">
          <div className="flex flex-wrap items-center justify-between gap-2 p-2 rounded-lg bg-black/40 backdrop-blur-sm border border-neon-cyan/20">
            <Badge 
              variant="outline" 
              className="border-neon-cyan/50 text-neon-cyan flex items-center gap-1.5 px-2 py-1"
            >
            ...
            {isWalletConnected && primaryWallet ? (
              ...
              <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-orange-500/10 border border-orange-500/30">
          ...
          {!isLoading && !gameState.isPlaying && !gameMode && (
            ...
            >
              ...
              <div className="text-center py-4">
                <h2 
                  className="cyber-title font-display text-2xl sm:text-3xl md:text-4xl text-neon-cyan mb-2"
