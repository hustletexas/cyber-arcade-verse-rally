  ...
  const handleBuyTickets = (event: TourEvent) => {
    if (event.status === 'available') {
      toast({
        ...
        description: `Redirecting to purchase tickets for ${event.city} show...`,
      });
      ...
      setTimeout(() => {
        toast({
          ...
          description: `Your tickets for ${event.city} have been confirmed!`,
        });
      }, 2000);
    }
  };
              ...
              {tourEvents.map((event) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-neon-green font-bold">${event.price}</span>
                    <Button
                      onClick={(e) => {
                        e.stopPropagation();
