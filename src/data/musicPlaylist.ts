...
export const cyberDreamsPlaylist: Playlist = {
  ...
  description: 'A collection of futuristic synthwave, cyberpunk, lo-fi, chiptune, vaporwave, and drum & bass tracks',
  ...
  tracks: [
    ...
    {
      id: '22',
      title: 'Ａｅｓｔｈｅｔｉｃ Ｆｌｏｗ',
      artist: 'Digital Nostalgia',
      url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3',
      duration: 267,
      genre: 'Vaporwave',
      artwork: '/lovable-uploads/electric-midnight.png',
